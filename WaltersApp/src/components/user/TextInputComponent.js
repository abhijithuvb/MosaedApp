...
const TextInputComponent = (props) => {
    ...
    const { label, fullWidth, fullHeight } = props
    return (
        <View style={[{ width: fullWidth ? '100%' : WIDTH * 0.6417, borderBottomWidth: 1.2, borderBottomColor: colors.yellow,  /* paddingVertical: HEIGHT * 0.01 */ }]}>
            ...
            <View style={[commonStyles.flexDirection(lang)]}>
                ...
                <View style={[Platform.OS == "android" ? { paddingVertical: lang == 'en' ? HEIGHT * 0.008 : HEIGHT * 0.01, } : {
                    paddingVertical: lang == 'en' ? HEIGHT *
                        0.002 : HEIGHT * 0.001,
                }, { width: WIDTH * 0.2891, height: fullHeight ? HEIGHT * 0.15 : HEIGHT * 0.0304, marginLeft: WIDTH * 0.012, marginBottom: HEIGHT * 0.009 }]}>
                    <TextInput style={[{ height: fullHeight ? HEIGHT * 0.15 : HEIGHT * 0.0304, color: colors.lightblack, padding: 0, fontSize: 16, }, commonStyles.textAlign(lang)]} />
                </View>
            </View>
