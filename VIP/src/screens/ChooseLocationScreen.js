        ...
        <View style={{ backgroundColor: '#181D23', flex: 1 }}>
            <View style={[{ flex: 1, }, Platform.OS === "android" ? { marginTop: HEIGHT * 0.03, } : { marginTop: HEIGHT * 0.06 }]}>
                ...
                <View style={{ flex: 1, backgroundColor: '#0FC1A1' }}>
                    <View style={{ height: Platform.OS === "android" ? HEIGHT * 0.87 : HEIGHT * 0.85, backgroundColor: '#181D23', borderBottomLeftRadius: HEIGHT * 0.02, borderBottomRightRadius: HEIGHT * 0.02 }}>
                        ...
                        <View style={{ width: WIDTH * 0.9, alignSelf: 'center' }}>
                            ...
                            <View>
                                <FlatList
                                    ...
                                    data={filtered}
                                    renderItem={({ item, index }) => <LocationListComponent
                                        location={item.location}
                                        index={index}
                                        state={locationDetails} onPressFunction={(location, index) => setLocationDetails({ ...locationDetails, place: location, index: index })} />} />
                            </View>
                        </View>
