            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, backgroundColor: '#0FC1A1' }}>
                    <View style={{ height: HEIGHT * 0.83, backgroundColor: 'black', borderBottomLeftRadius: HEIGHT * 0.02, borderBottomRightRadius: HEIGHT * 0.02 }}>
                        <View style={[{ height: HEIGHT * 0.41, backgroundColor: '#181D23', borderBottomLeftRadius: HEIGHT * 0.02, borderBottomRightRadius: HEIGHT * 0.02 }]}>
                            <View style={[Platform.OS === "android" ? { marginTop: HEIGHT * 0.02 } : { marginTop: HEIGHT * 0.06 }]}>
                                <HeaderComponent leftlogo={backarrow} title={"SUMMARY"} leftOnPress={() => navigation.goBack()} />
                            </View>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginTop: HEIGHT * 0.03 }}>
